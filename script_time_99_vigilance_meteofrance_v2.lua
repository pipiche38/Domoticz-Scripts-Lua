...
local dev_alert_vague          = nil    -- renseigner le nom de l'éventuel device alert vigilance vague submersion associé (dummy - alert)
...
local dev_commentaire_meteo    = 'Commentaire Météo'     -- renseigner le nom de l'éventuel device texte Commentaire Météo associé si souhaité, sinon nil 
...
---------------- Fonctions -----------------
-------------------------------------------- 
package.path = package.path..";/var/lib/domoticz/scripts/lua/?.lua"   -- ligne à commenter en cas d'utilisation des fonctions directement dans ce script
