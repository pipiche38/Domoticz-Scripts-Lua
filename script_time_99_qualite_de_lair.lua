...
local dev_indice_alert = 'Alerte polution'	-- renseigner le nom du device alert pollution associé si souhaité, sinon nil (dummy - alert)
...
local dev_co = 'Monoxyde de Carbonne'		-- renseigner le nom du device monoxide de carbonne associé si souhaité, sinon nil (custom, nom de l'axe : AQI)
...
local dev_pm10 = 'Taux de Particules'		-- renseigner le nom du device taux de particules associé si souhaité, sinon nil (custom, nom de l'axe : AQI)
...
local aqi_token = "77407841399077cc282684d7f4e0b665c21a5ee0"
local token_aqicn = "aqi_token" 	-- renseigner le nom de la variable contenant le token aqicn de 40 caractères préalablement créé (variable de type chaine)
...
local latitude = 45.183896 		-- renseigner la latitude du lieu dont vous souhaitez remonter les informations de pollution ex : "45.84"
local longitude = 5.732514	 	-- renseigner la longitude du lieu dont vous souhaitez remonter les informations de pollution ex : "1.26"
...
--	local API_key = uservariables[token_aqicn] 
        local API_key = "77407841399077cc282684d7f4e0b665c21a5ee0"
